...
Imagine a complex project with a complex architecture. Imagine having to rebuild one of this project's features because it has multiples integrations that your project doesn't need or because you see a potential security flaw being developed with this new integration.
<br>
...
Api Gateways have a very important role in projects specially when it comes to big companies. Big companies have lots of internal automations and partnerships with other companies. It's important to keep track of what's available to use between the teams inside and outside the company and build architectures for security and performance monitoring. 
<br>
...
An Api Gateway is an application that intermediates Client/Server communication. It acts as an bridge between networks or applications inside the same network.
<br>
